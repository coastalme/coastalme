...
int const RTN_ERR_CSHORE_FILE_INPUT = 50;
int const RTN_ERR_READING_CSHORE_FILE_OUTPUT = 51;
...
int const RTN_ERR_OPEN_DEEP_WATER_WAVE_DATA = 57;
int const RTN_ERR_READING_DEEP_WATER_WAVE_DATA = 58;
int const RTN_ERR_BOUNDING_BOX = 59;
int const RTN_ERR_READING_SEDIMENT_INPUT_EVENT = 60;
int const RTN_ERR_SEDIMENT_INPUT_EVENT = 61;
int const RTN_ERR_SEDIMENT_INPUT_EVENT_LOCATION = 62;
int const RTN_ERR_WAVESTATION_LOCATION = 63;
int const RTN_ERR_FLOOD_LOCATION = 64;
int const RTN_ERR_CLIFF_NOT_IN_POLYGON = 65;
int const RTN_ERR_UNKNOWN = 66;
