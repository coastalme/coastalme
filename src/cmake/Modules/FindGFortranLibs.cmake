#########################################################################################
# From https://github.com/Argonne-National-Laboratory/PIPS/blob/master/cmake/Modules/FindGFortranLibs.cmake
#
# Bug fix and tidying by Dave Favis-Mortlock, May 2017
#
# FindGFortranLibs
# --------
#
...
#     message(STATUS "Detected default gfortran prefix")
   ...
   else (NOT GFORTRAN_PREFIX_STR)
      string(REGEX REPLACE "--prefix=([^\t\n ]+)" "\\1"
      GFORTRAN_PREFIX_DIR "${GFORTRAN_PREFIX_STR}")
   endif (NOT GFORTRAN_PREFIX_STR)
...
#   unset(GFORTRAN_LIB_DIR_STR)
   ...
   # TODO get this working for non-GNU Fortran compilers
   message(STATUS "Non-GNU Fortran compiler found: ${CMAKE_Fortran_COMPILER_ID MATCHES}")
