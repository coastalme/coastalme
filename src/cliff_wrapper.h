...
class CRWCliffWrap : public CACoastLandform
{
   private:
   ...
   protected:
   public:
   CRWCliffWrap(CRWCoast *, int const, int const, double const, double const, double const, double const);
   ~CRWCliffWrap(void) override;
